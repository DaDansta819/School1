...
w2=1; a2=.75;
T2=linspace(158.16,329.0,232);
 T4=linspace(349.79,264.09,232);
 T3=linspace(123.15,29.44,232);
 ...
 A3(1)
 A4(1)
fprintf('Omega3 at full deployment is %d rad/s \n',W3(232))
fprintf('Omega4 at full deployment is %d rad/s \n\n',W4(232))
fprintf('Alpha3 at full deployment is %d rad/s^2 \n',A3(232))
fprintf('Alpha4 at full deployment is %d rad/s^2 \n\n',A4(232))
fprintf('Position of wheel in x direction at full deployment is %d feet \n',Xp(232))
fprintf('Position of wheel in y direction at full deployment is %d feet \n\n',Yp(232))
fprintf('Velocity of wheel in x direction at full deployment is %d ft/s \n',Xpd(232))
fprintf('Velocity of wheel in y direction at full deployment is %d ft/s \n\n',Ypd(232))
fprintf('Acceleration of wheel in x direction at full deployment is %d ft/s^2 \n',Xpdd(232))
fprintf('Acceleration of wheel in y direction at full deployment is %d ft/s^2 \n',Ypdd(232))
%Graphs
P=1:232;
